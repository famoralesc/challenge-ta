...
class MyAppTests(TestCase):
    ...
    def test_get_data_to_persist(self, mock_get_alert_type):
        ...
        expected_result = [
            {"datetime": "2023-06-27T00:00:00Z", "type": "BAJA", "version": 1, "value": 250},
            {"datetime": "2023-06-27T01:00:00Z", "type": "MEDIA", "version": 1, "value": 600},
            {"datetime": "2023-06-27T02:00:00Z", "type": "ALTA", "version": 1, "value": 900},
        ]
    ...
    def test_process(self, mock_create, mock_get_data_to_persist, mock_get_data_from_influx):
    ...
    def test_get_alerts_by_criteria(self, mock_filter):
        ...
        expected_result = [
            {"datetime": "2023-06-27 00:00:00", "value": 250, "version": 1, "type": 'BAJA', "sended": False}
        ]
